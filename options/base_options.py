...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default=r'../../datasets',
                            help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--dataroot', default=r'D:\aalixiang\comparasion\data',
        #                     help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--dataroot', default=r'data',
        #                     help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--name', type=str, default='song',
        ...
        parser.add_argument('--dataset_mode', type=str,
                            default='cn_few_fusion', help='multi_fusion,aligned,single')
        ...
        # models
        parser.add_argument('--vgg', type=str, default=r'D:\aalixiang\comparasion\vgg19-dcbb9e9d.pth',
        ...
        parser.add_argument('--conditional_D', action='store_true', default=True,
